...
import 'package:hello/features/home/screens/ai_budget_recommendation.dart';
...
class _UserHomeState extends State<UserHome> {
  ...
  Widget _buildAIBudgetCard() {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 24.0),
      child: GestureDetector(
        onTap: () => Navigator.push(
          context,
          MaterialPageRoute(builder: (_) => const AIBudgetRecommendation()),
        ),
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 16),
              Text(
                'Let our AI analyze your budget and create personalized spending recommendations for meals, laundry, and maintenance.',
                style: GoogleFonts.inter(
                  color: Colors.white,
                  fontSize: 13,
                  height: 1.5,
